...
// Styling
export const general = css({fontFamily: 'Consolas, monaco, monospace', 
                      width: 80 * 12 + 'px', 
                      paddingLeft: 10 + 'px', 
                      paddingRight: 10 + 'px',
                      margin: 'auto',
...
export const left = css({float: 'left', textAlign: 'right', width: 80 * 5 + 'px'})
export const right = css({float: 'right', textAlign: 'left', width: 80 * 5 + 'px'})
